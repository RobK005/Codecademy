...
function create() {
    ...
    gameState.label = this.add.text(160, 300, 'Click me!');

    // switchedOn state here
    gameState.switchedOn = 'rect1';

    // gameState.rect as interactive here
    gameState.rect2.setInteractive();
    gameState.rect1.setInteractive();
    // pointerup listener for rect here
